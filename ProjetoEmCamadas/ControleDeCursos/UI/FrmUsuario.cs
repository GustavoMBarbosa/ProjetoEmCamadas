...
namespace ControleDeCursos
{
    ...
    {
        Usuario objProfessor = new Usuario();
        public FrmUsuario()
        {
            InitializeComponent();
            txtid.Enabled = false;
            dtgProfessor.DataSource = objProfessor.ListarUsuario();
        }
        ...
        {
            objProfessor.nome = txtUsuario.Text;
            objProfessor.senha = txtSenha.Text;
            objProfessor.email = txtEmail.Text;
            

            objProfessor.CadastrarUsuario();
        ...
        {
            objProfessor.id = int.Parse(txtid.Text);
            objProfessor.ExcluirUsuario();
